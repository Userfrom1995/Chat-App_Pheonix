defmodule EshMessenger.AccountsTest do
  use EshMessenger.DataCase

  alias EshMessenger.Accounts

  describe "users" do
    alias EshMessenger.Accounts.User

    import EshMessenger.AccountsFixtures
